...
/***/ "./src/admin/components/TwitterSettingsModal.js":
/*!******************************************************!*\
  !*** ./src/admin/components/TwitterSettingsModal.js ***!
  \******************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TwitterSettingsModal; });
...
var settingsPrefix = 'ghostiq-flarumtwitter.';
var translationPrefix = 'ghostiq-flarumtwitter.admin.settings.';

var TwitterSettingsModal =
/*#__PURE__*/
function (_SettingsModal) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(TwitterSettingsModal, _SettingsModal);

  function TwitterSettingsModal() {
    return _SettingsModal.apply(this, arguments) || this;
  }

  var _proto = TwitterSettingsModal.prototype;
  ...
  _proto.form = function form() {
    return [m('.Form-group', [m('label', app.translator.trans(translationPrefix + 'field.consumerAPI')), m('input.FormControl', {
      bidi: this.setting(settingsPrefix + 'consumerAPI'),
      placeholder: 'Consumer API Key'
    })]), m('.Form-group', [m('label', app.translator.trans(translationPrefix + 'field.consumerAPISecret')), m('input.FormControl', {
      bidi: this.setting(settingsPrefix + 'consumerAPISecret'),
      placeholder: 'Consumer API Secret Key'
    })]), m('.Form-group', [m('label', app.translator.trans(translationPrefix + 'field.accessToken')), m('input.FormControl', {
      bidi: this.setting(settingsPrefix + 'accessToken'),
      placeholder: 'Access Token'
    })]), m('.Form-group', [m('label', app.translator.trans(translationPrefix + 'field.accessTokenSecret')), m('input.FormControl', {
      bidi: this.setting(settingsPrefix + 'accessTokenSecret'),
      placeholder: 'Access Token Secret'
    })]), m('.Form-group', [m('label', app.translator.trans(translationPrefix + 'field.tagIdToFollow')), m('input.FormControl', {
      bidi: this.setting(settingsPrefix + 'tagIdToFollow'),
      placeholder: 'Tag id to follow'
    })]), m('.Form-group', [m('label', app.translator.trans(translationPrefix + 'field.tagIdToFollow1')), m('input.FormControl', {
...
/* harmony import */ var _components_TwitterSettingsModal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/TwitterSettingsModal */ "./src/admin/components/TwitterSettingsModal.js");
